(function (g) {
    g.ketchup = {
        ...
        addMessage: function (b, c) {
            if (this.validations[b])
                this.validations[b].message = c
        },
        helper: function (b, c) {
            this.helpers[b] = c;
            return this
        ...
        elementIsValid: function (b) {
            ...
            } else if (b.data(c.elements))
                return this.allFieldsValid(b);
            return null
        },
        ...
        extractEvents: function (b, c) {
            var d = false
                , h = b.indexOf(c + "(");
            if (h != -1)
                d = b.substr(h + c.length + 1).split(")")[0];
            return d
        },
